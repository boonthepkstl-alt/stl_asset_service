...
**Source:** [`RAISE-ACCEPTANCE-CRITERIA.md`](../04-acceptance-criteria/RAISE-ACCEPTANCE-CRITERIA.md) v0.13, cross-checked against [`RAISE-PRD.md`](../01-requirements/RAISE-PRD.md) v0.16, [`RAISE-DESIGN.md`](../02-design/RAISE-DESIGN.md) v0.14, [`RAISE-PROTOTYPE.md`](../03-prototype/RAISE-PROTOTYPE.md) v0.15
...
**Version:** 0.13 (re-synced against `RAISE-ACCEPTANCE-CRITERIA.md` v0.13, 2026-09-04 —
Alerts screen access gate resolved, per confirmed business decision)
