...
| *(pending — PR #18)* | 2026-08-24 | `docs/checkpoints-structured-template` | Rewrite `PROJECT-CHECKPOINTS.md` with the structured template (17 PRs retroactively converted) + add `SESSION-CLOSEOUT-PROTOCOL.md` (14-step close-out checklist, 3-level checkpoint model) | Docs |
