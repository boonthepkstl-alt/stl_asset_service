...
**Source:** [`RAISE-ACCEPTANCE-CRITERIA.md`](../04-acceptance-criteria/RAISE-ACCEPTANCE-CRITERIA.md) v0.18, cross-checked against [`RAISE-PRD.md`](../01-requirements/RAISE-PRD.md) v0.20, [`RAISE-DESIGN.md`](../02-design/RAISE-DESIGN.md) v0.18, [`RAISE-PROTOTYPE.md`](../03-prototype/RAISE-PROTOTYPE.md) v0.19. **The v0.17 → v0.18 sync was performed 2026-09-08**, propagating PRD §16 Resolved Question 52 (confirmed by business 2026-09-08), which amends Resolved Question 46 — the NBV useful-life configuration is re-keyed from Asset Category to Asset Type (a re-key, not new scope; see Document Status Change Log). **A follow-up correction, v0.18 → v0.19, was performed the same day (2026-09-08)**: it replaces this document's stale trailing Status/Source/Next Action footer block (previously still citing AC v0.14 and a nine-tile grid, four revisions behind this document's own header) and confirms, by individual inspection, that all 9 occurrences of the superseded `Record<AssetCategory, usefulLifeYears>` string elsewhere in this document are explicit re-key/correction notes, not live spec text — no useful-life number is invented anywhere; see Document Status Change Log
...
**Status:** Draft for Test Plan Review
**Source:** [`RAISE-ACCEPTANCE-CRITERIA.md`](../04-acceptance-criteria/RAISE-ACCEPTANCE-CRITERIA.md) v0.18
**Reference:** VERSCAN only
...
already-underway follow-up. No PASS/FAIL execution result is claimed by this Test Plan
document itself; Open Finding F-03 stays OPEN (narrowed, not closed).
