...
|---|---|---|---|---|---|
| TS-LOGIN | 3 | 0 | 3 | 0 | 0 |
| TS-DASH | 6 | 5 | 0 | 0 | 1 (`TC-DASH-03c` — Risk, confirmed out of MVP scope) |
...
| TS-EXEC-001 | 6 | 5 | 0 | 0 | 1 (`TC-EXEC-001-03c` — Risk, confirmed out of MVP scope) |
