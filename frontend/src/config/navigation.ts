...
const allNavGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'handovers', label: 'Asset Handovers', icon: ArrowRightLeft, group: 'Assets' },
...
export const pageTitles: Record<string, { title: string; subtitle: string }> = {
  ...
  handovers: { title: 'Asset Handovers', subtitle: '4-Stage IT Hardware Assignment Approval Workflow: Recipient Confirmation ➔ IT Processing ➔ IT Supervisor Approval' },
